...
| 文档 | 说明 |
| --- | --- |
| [2026-08-18-audit-followups.md](./superpowers/specs/2026-08-18-audit-followups.md) | 2026-08-18 全仓审计的存续结论。批次 1–6 的 28 个条目已全部实施（PR #45–#50），实施记录正文已裁剪掉；本文只剩三条长期方向（CI + provenance 发布、私网拦截子网化、定价漂移检查）、九条「明确不做的事」，以及编号 L6 的结案说明 |
