...
**Status:** accepted — 批次 1–6 由 PR #45–#50 实施；批次 7（长期方向）未实施。
本文是实施口径的唯一依据；与代码冲突时以代码及其注释为准。
**日期:** 2026-08-18（rev 3，含第二轮文档复核后的修订，见文末「修订记录」）
...
**编号 L6 在本方案中不存在**，且 2026-08-18 审计的原始汇总未落盘到本仓（`docs/superpowers/specs/` 下只有 2026-07-24 / 07-27 / 08-04 三份更早的设计文档）。
因此「本方案覆盖了审计的全部结论」这一前提**目前无法核对**。执行前必须先把审计汇总落盘，并确认 L6 是已修复、已判为无效，还是漏收。
