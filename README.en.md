...
- Parent-session assistant usage is counted at `message_end`, sampled before the SDK's zero-fill. Missing fields stay unknown; SDK-filled zeros are not treated as reported.
